...
int screen_1_digital_clock_1_sec_value = 59;
char screen_1_digital_clock_1_meridiem[] = "PM";
int screen_1_date_year_init_value = 2023;
int screen_1_date_month_init_value = 1;
int screen_1_date_day_init_value = 31;

static int screen_1_calc_weekday_monday0_init(int year, int month, int day)
{
    int y;
    int m;
    int k;
...
void setup_scr_screen_1(lv_ui *ui)
{
    ...
    ui->screen_1_digital_clock_1 = lv_dclock_create(ui->screen_1_cont_1, NULL);
    lv_dclock_set_text_fmt(ui->screen_1_digital_clock_1,
                           "%d:%02d %s",
    ...
    lv_label_set_text_fmt(ui->screen_1_datetext_1,
                          "%d/%02d/%02d",
                          screen_1_date_year_init_value,
    ...
    lv_obj_set_size(ui->screen_1_datetext_1, 160, 33);
    ...
    //Write codes screen_1_weather_divider_line
    /*
     * 天气方框内分割线：位于方框高度 1/3 处
     * 方框坐标与尺寸：x=140, y=51, w=203, h=172
     * 线条Y：150
     */
    lv_obj_t *screen_1_weather_divider_line = lv_obj_create(ui->screen_1_cont_1);
    lv_obj_set_pos(screen_1_weather_divider_line, 142, 150);
    lv_obj_set_size(screen_1_weather_divider_line, 199, 2);
    lv_obj_clear_flag(screen_1_weather_divider_line, LV_OBJ_FLAG_SCROLLABLE);
    lv_obj_clear_flag(screen_1_weather_divider_line, LV_OBJ_FLAG_CLICKABLE);

    //Write style for screen_1_weather_divider_line, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_radius(screen_1_weather_divider_line, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(screen_1_weather_divider_line, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(screen_1_weather_divider_line, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(screen_1_weather_divider_line, lv_color_hex(0x6667ff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(screen_1_weather_divider_line, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(screen_1_weather_divider_line, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(screen_1_weather_divider_line, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(screen_1_weather_divider_line, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(screen_1_weather_divider_line, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(screen_1_weather_divider_line, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_1_label_weather_main
    /* 左侧：实时天气 ITEM:text（最多4字，较大字号） */
    ui->screen_1_label_weather_main = lv_label_create(ui->screen_1_cont_1);
    lv_label_set_text(ui->screen_1_label_weather_main, "--");
    lv_obj_set_pos(ui->screen_1_label_weather_main, 148, 176);
    lv_obj_set_size(ui->screen_1_label_weather_main, 108, 34);
    lv_label_set_long_mode(ui->screen_1_label_weather_main, LV_LABEL_LONG_CLIP);
    lv_obj_set_style_text_align(ui->screen_1_label_weather_main, LV_TEXT_ALIGN_LEFT, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->screen_1_label_weather_main, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_1_label_weather_main, &lv_font_SourceHanSerifSC_Regular_30, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->screen_1_label_weather_main, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui->screen_1_label_weather_main, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->screen_1_label_weather_main, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->screen_1_label_weather_main, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->screen_1_label_weather_main, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->screen_1_label_weather_main, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_1_label_weather_day
    /* 右侧：今日白天天气 ITEM:todayTextDay（最多4字，小号） */
    ui->screen_1_label_weather_day = lv_label_create(ui->screen_1_cont_1);
    lv_label_set_text(ui->screen_1_label_weather_day, "--");
    lv_obj_set_pos(ui->screen_1_label_weather_day, 258, 184);
    lv_obj_set_size(ui->screen_1_label_weather_day, 76, 24);
    lv_label_set_long_mode(ui->screen_1_label_weather_day, LV_LABEL_LONG_CLIP);
    lv_obj_set_style_text_align(ui->screen_1_label_weather_day, LV_TEXT_ALIGN_RIGHT, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->screen_1_label_weather_day, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_1_label_weather_day, &lv_font_SourceHanSerifSC_Regular_17, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->screen_1_label_weather_day, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui->screen_1_label_weather_day, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->screen_1_label_weather_day, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->screen_1_label_weather_day, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->screen_1_label_weather_day, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->screen_1_label_weather_day, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_img_set_src(ui->screen_1_img_11, NULL);
    ...
    lv_span_set_text(ui->screen_1_spangroup_12_span,
                     week_days[screen_1_calc_weekday_monday0_init(screen_1_date_year_init_value,
                                                                  screen_1_date_month_init_value,
                                                                  screen_1_date_day_init_value)]);
