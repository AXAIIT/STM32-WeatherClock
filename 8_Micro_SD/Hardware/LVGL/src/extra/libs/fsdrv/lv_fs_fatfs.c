...
#include "../../../lvgl.h"
        ...
        #define LV_FATFS_HEADER_FOUND 1
    #else
        #define LV_FATFS_HEADER_FOUND 0
    #endif
...
#if LV_USE_FS_FATFS && LV_FATFS_HEADER_FOUND
#include "ff.h"
...
#elif LV_USE_FS_FATFS && !LV_FATFS_HEADER_FOUND

void lv_fs_fatfs_init(void)
{
    LV_LOG_WARN("lv_fs_fatfs disabled at build time: missing ff.h");
}
